...
class FfprobeTracks {
  static Future<List<SubtitleTrackInfo>> probe(String ffprobe, String videoPath) async {
    ...
    for (final s in streams) {
      ...
      final disposition = (map['disposition'] as Map?)?.cast<String, dynamic>() ?? {};
      out.add(SubtitleTrackInfo(
        id: subOrdinal,
        streamIndex: map['index'] as int?,
        codec: (map['codec_name'] ?? map['codec_tag_string'] ?? '').toString(),
